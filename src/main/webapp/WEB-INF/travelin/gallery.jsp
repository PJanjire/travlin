...
<img src="images/temple/insta7.jpg" alt="image" height="375">
</div>
<div class="gallery-content">
    <!--
<h5 class="white text-center position-absolute bottom-0 pb-4 left-50 mb-0 w-100">Barcelona - Spain</h5>-->
<ul>
<li><a href="images/temple/insta7.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
...
<div class="gallery-item mb-4 rounded overflow-hidden">
<div class="gallery-image">
<img src="images/temple/tm7.jpg" alt="image">
</div>
<div class="gallery-content">
<!--<h5 class="white text-center position-absolute bottom-0 pb-4 left-50 mb-0 w-100">Beijing - China</h5>-->
<ul>
<li><a href="images/temple/tm7.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
<li><a href="#"><i class="fa fa-link"></i></a></li>
</ul>
</div>
</div>
...
<div class="gallery-item mb-4 rounded overflow-hidden">
<div class="gallery-image">
<img src="images/temple/insta6.jpg" alt="image">
</div>
<div class="gallery-content">
<!--<h5 class="white text-center position-absolute bottom-0 pb-4 left-50 mb-0 w-100">Moscow - Russia</h5>-->
<ul>
<li><a href="images/temple/insta6.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
<li><a href="#"><i class="fa fa-link"></i></a></li>
</ul>
</div>
</div>
...
<div class="gallery-item mb-4 rounded overflow-hidden">
<div class="gallery-image">
<img src="images/temple/temple.jpg" alt="image" height="262">
</div>
<div class="gallery-content">
<!--<h5 class="white text-center position-absolute bottom-0 pb-4 left-50 mb-0 w-100">Bangkok - Thailand</h5>-->
<ul>
<li><a href="images/temple/temple.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
<li><a href="#"><i class="fa fa-link"></i></a></li>
</ul>
</div>
</div>
...
<div class="gallery-item mb-4 rounded overflow-hidden">
<div class="gallery-image">
<img src="images/temple/tirupati1.webp" alt="image" height="262">
</div>
<div class="gallery-content">
<!--<h5 class="white text-center position-absolute bottom-0 pb-4 left-50 mb-0 w-100">FLorida - USA</h5>-->
<ul>
<li><a href="images/temple/tirupati1.webp" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
<li><a href="#"><i class="fa fa-link"></i></a></li>
</ul>
</div>
</div>
...
<div class="gallery-item mb-4 rounded overflow-hidden">
<div class="gallery-image">
<img src="images/temple/tm9.jpg" alt="image" height="240">
</div>
<div class="gallery-content">
<!--<h5 class="white text-center position-absolute bottom-0 pb-4 left-50 mb-0 w-100">Tokyo - Japan</h5>-->
<ul>
<li><a href="images/temple/tm9.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
<li><a href="#"><i class="fa fa-link"></i></a></li>
</ul>
</div>
</div>
...
<div class="gallery-item mb-4 rounded overflow-hidden">
<div class="gallery-image">
<img src="images/temple/tm11.jpg" alt="image" height="240">
</div>
<div class="gallery-content">
<!--<h5 class="white text-center position-absolute bottom-0 pb-4 left-50 mb-0 w-100">Bali - Indonesia</h5>-->
<ul>
<li><a href="images/temple/tm11.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
<li><a href="#"><i class="fa fa-link"></i></a></li>
</ul>
</div>
</div>
...
<div class="gallery-item mb-4 rounded overflow-hidden">
<div class="gallery-image">
<img src="images/temple/tm17.jpg" alt="image" height="240">
</div>
<div class="gallery-content">
<!--<h5 class="white text-center position-absolute bottom-0 pb-4 left-50 mb-0 w-100">Bangkok - Thailand</h5>-->
<ul>
<li><a href="images/temple/tm17.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
<li><a href="#"><i class="fa fa-link"></i></a></li>
</ul>
</div>
</div>
...
<div class="gallery-item mb-4 rounded overflow-hidden">
<div class="gallery-image">
<img src="images/temple/tm26.jpg" alt="image" height="240">
</div>
<div class="gallery-content">
<!--<h5 class="white text-center position-absolute bottom-0 pb-4 left-50 mb-0 w-100">Bangkok - Thailand</h5>-->
<ul>
<li><a href="images/temple/tm26.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
<li><a href="#"><i class="fa fa-link"></i></a></li>
</ul>
</div>
</div>
...
<script>(function(){var js = "window['__CF$cv$params']={r:'734c651b5ab085bd',m:'M5VPA6kbDiydl.s_IFsaDIL1Ab2xcPWGPbQ0ck3LQPY-1659501833-0-ATSKq2M4llMPofMmaK1xcXFBOLqjHl5N+cdVp9boM30YzfKPSGWE6ygOwRUWOh7gPhLzAFUQgW4jNw4GAjZvAZ2Z0unP0RixmjiGa8LZRxRZtOdieWI/XJSSF0WnXgj15hh6b1yI4Fh01R25+DWpzHg=',s:[0xf449b758b5,0x9ec83f45d2],u:'/cdn-cgi/challenge-platform/h/b'};var now=Date.now()/1000,offset=14400,ts=''+(Math.floor(now)-Math.floor(now%offset)),_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/h/b/scripts/alpha/invisible.js?ts='+ts,document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
</html>