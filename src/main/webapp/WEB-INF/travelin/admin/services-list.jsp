...
<p class="tx-12 text-muted"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="82ece7eef1edececc2e5efe3ebeeace1edef">[email&#160;protected]</a></p>
</div>
</div>
...
<button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addservices"><i class="link-icon" data-feather="plus"></i> Add Service</button>
</nav>
...
<td>Share Your Travel Locations</td>
...
<li class="me-2"><a href="#" data-bs-toggle="modal" data-bs-target="#addmarquee"><i class="link-icon" data-feather="edit"></i></a></li>
...
<h5 class="modal-title" id="exampleModalLabel">Add Top Service</h5>
</div>
...
<div class="mb-3">
<label for="upload" class="form-label">Upload Icon</label>
<input class="form-control" type="file" id="upload">
</div>
<div class="text-center">
<button type="submit" class="btn btn-primary"><i class="link-icon" data-feather="plus"></i> Create Services</button>
</div>
</form>
</div>
</div>
...
<script>(function(){var js = "window['__CF$cv$params']={r:'734c6c2f2b1285bd',m:'IW1QbArBRfAH1dZZrcLYJeoQ5dtPS0Yn4.Ircjg98KA-1659502124-0-AdNG/CYr0RcvP4ou4taL3DaK7JWPsz3zdTh2fL3JAupaNeG1lETXRrEzYtQsBspqIYcftOSbCSWY4jysbQNmA+qDQSCGhMQpWFHWbOW3md+eef/K/pu3nMpLKQ+pH+qS9uYUBHOYJV0tTLuWJg2huehechMyE83GlZuGF8E6ILq0',s:[0x54836afdfb,0xdaba2b96a4],u:'/cdn-cgi/challenge-platform/h/b'};var _cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/h/b/scripts/cb/invisible.js?cb=734c6c2f2b1285bd',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
</html> 