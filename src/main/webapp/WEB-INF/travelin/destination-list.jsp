...
<img src="images/temple/tm20.jpg" alt="image" height="400">
...
<h5 class="mb-0"><a href="destination-detail" class="theme1">Maharashtra</a></h5>
...
<div class="trend-item1">
<div class="trend-image position-relative rounded">
<img src="images/temple/Surya_mandir.jpg" alt="image" height="400">
<div class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
<div class="trend-content-title">
<h5 class="mb-0"><a href="destination-detail" class="theme1">Odisha</a></h5>
<h3 class="mb-0 white">India</h3>
</div>
...
<div class="trend-item1">
<div class="trend-image position-relative rounded">
<img src="images/temple/Hampi.jpg" alt="image" height="400">
<div class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100">
<div class="trend-content-title">
<h5 class="mb-0"><a href="destination-detail" class="theme1">Karnataka</a></h5>
<h3 class="mb-0 white">India</h3>
 </div>
...
<div class="trend-item1">
<div class="trend-image position-relative rounded">
<img src="images/temple/insta1.jpg" alt="image" height="400">
<div class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
<div class="trend-content-title">
<h5 class="mb-0"><a href="destination-detail" class="theme1">Panjab</a></h5>
<h3 class="mb-0 white">India</h3>
</div>
...
<div class="trend-item1">
<div class="trend-image position-relative rounded">
<img src="images/temple/insta2.jpg" alt="image" height="400">
<div class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
<div class="trend-content-title">
<h5 class="mb-0"><a href="destination-detail" class="theme1">Kerala</a></h5>
<h3 class="mb-0 white">India</h3>
</div>
...
<div class="trend-item1">
<div class="trend-image position-relative rounded">
<img src="images/temple/Badrinath.jpg" alt="image" height="400">
<div class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
<div class="trend-content-title">
<h5 class="mb-0"><a href="destination-detail" class="theme1">Jammu & kashmir</a></h5>
<h3 class="mb-0 white">India</h3>
</div>
...
<div class="trend-item1">
<div class="trend-image position-relative rounded">
<img src="images/temple/Dwaraka.jpg" alt="image" height="400"> 
<div class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
<div class="trend-content-title">
<h5 class="mb-0"><a href="destination-detail" class="theme1">Uttar Pradesh</a></h5>
<h3 class="mb-0 white">India</h3>
</div>
<span class="white bg-theme p-1 px-2 rounded">18 Tours</span>
 </div>
...
<div class="trend-item1">
<div class="trend-image position-relative rounded">
<img src="images/temple/tirupati.webp" alt="image" height="400">
<div class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
<div class="trend-content-title">
<h5 class="mb-0"><a href="destination-detail" class="theme1">Andhra Pradesh</a></h5>
<h3 class="mb-0 white">India</h3>
</div>
<span class="white bg-theme p-1 px-2 rounded">21 Tours</span>
</div>
...
<div class="trend-item1">
<div class="trend-image position-relative rounded">
<img src="images/temple/Budhha.jpg" alt="image" height="400">
<div class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100">
<div class="trend-content-title">
<h5 class="mb-0"><a href="destination-detail" class="theme1">Kathmandu</a></h5>
<h3 class="mb-0 white">Nepal</h3>
</div>
<span class="white bg-theme p-1 px-2 rounded">15 Tours</span>
</div>
<div class="color-overlay"></div>
...
<script>(function(){var js = "window['__CF$cv$params']={r:'734c649e7bd385bd',m:'w2MWXhxu8LWAjnS4bMUJ9EdCr9q2vnEVEowWGpU70TA-1659501814-0-ATPstVkJ21bqu3bC4KXu2KE+OeXHmTGPRnASqYC5QsY00Lmurw4d4wKDxx7NIGpjT34HmvSOoa1q4RU2WTFR6+dZ4s8evYn153KpdWv/lFPGF/MLjE/wlQBHIAMsSO2X99XOIsRHCq1lZXxCdNn+BrNNQAkWJ9IQQwHd6pNT3duF',s:[0x05f31356e3,0x2636bbd2cd],u:'/cdn-cgi/challenge-platform/h/b'};var now=Date.now()/1000,offset=14400,ts=''+(Math.floor(now)-Math.floor(now%offset)),_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/h/b/scripts/alpha/invisible.js?ts='+ts,document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
</html>